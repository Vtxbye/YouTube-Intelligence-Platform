...
printenv | grep -E "^(YT_API_KEY|DB_MAX|MONTHS_BACK|MIN_DURATION_SECONDS|MIN_VIEWS|OLLAMA_MODEL|OLLAMA_URL|OUT_CSV|STATE_FILE|DISCOVERY_PAGES_PER_QUERY|PLAYLIST_PAGES_PER_CHANNEL|MAX_VIDEOS_PER_CHANNEL|MAX_COLLECT_CHANNELS|EXCLUDE_MADE_FOR_KIDS|NEGATIVE_TERMS)=" \
